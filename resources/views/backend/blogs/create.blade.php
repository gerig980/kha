...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Krijo Blog</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                    <li class="breadcrumb-item active">Krijo Blog</li>
                </ol>
            </div>
...
<form  autocomplete="off" class="needs-validation" method="post" action="{{ route('blog.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-11">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="title"  placeholder="Titulli i Blogut" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label" for="title">Blog Title English</label>
                                <input type="text" class="form-control" name="title_en"  placeholder="Titulli i Blogut Anglisht" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                           <div class="mb-4">
                                ...
                                {{-- <div class="avatar-lg bg-light rounded p-1">
                                    <img src="{{ URL::asset()}}" class="img-fluid d-block">
                                </div><br> --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <textarea name="description_en" id="ckeditor-classic_en" ></textarea>
                        </div>
                    </div>
                    <!-- <div class="row">-->
                    <!--    <div class="col-6">-->
                    <!--        <label class="form-label" for="description_en">Description</label>-->
                    <!--        <textarea name="description_en" id="ckeditor-classic_en" required>-->
                    <!--    </div>-->
                    <!--</div>-->

                    <div class="row ">
                    <div class="col-6 mt-4 d-flex flex-column">
                        <label for="tag"> Vendosni tag te ndare me presje</label>
                        <input
                          type="text"
